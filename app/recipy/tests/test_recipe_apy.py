...
def image_upload_url(recipe_id):
    ...
    return reverse('recipy:recipe-upload-image', args=[recipe_id])
...
def detail_url(recipe_id):
    ...
    return reverse('recipy:recipe-detail', args=[recipe_id])
...
class RecipeImageUploadTests(TestCase):
    ...
    def tearDown(self):
        # Removes images that are lingering around after the test
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe3 = sample_recipe(user=self.user, name='Fish and chips')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        ingredient2 = sample_ingredient(user=self.user, naem='Chicken')
